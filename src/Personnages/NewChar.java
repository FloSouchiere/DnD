...
public class NewChar {
	...
	public static ArrayList<Character> create(ArrayList<Character> charList, Scanner scan) {
		int input = 0;		
	...
	private static void createWizard(ArrayList<Character> charList, Scanner scan, String char_name) {
		int input;
	...
	private static void createWarrior(ArrayList<Character> charList, Scanner scan, String char_name) {
		int input;
